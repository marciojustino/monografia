...
\subsection{Entropia da Informação}
...
Muito embora a entropia, juntamente com a abordagem estatística dos dados funcione para tipos de arquivos que apresentam um padrão definido,
significativamente, esta não funciona tão bem quando o padrão de dados não tão óbvios \cite[p.~237]{Suganthan2010}.

% incluir a análise de entropia sobre o aspecto de um arquivo de imagem representado em binário.
% PÁG: 13 DO ARQUIVO ``KLOET_2007''