...
A análise de conteúdo por entropia já foi estudada e utilizada por pesquisadores e estudiosos da área forense com o objetivo de identificar conteúdo
oculto em um determinado arquivo, atribuído a uma técnica anti-forense comumente usada conhecida como \emph{Esteganografia}. Quando aplicada na
identificação de conteúdo oculto ou modificado, tem apresentado excelentes resultados por determinar alterações bruscas nas características dos dados
de blocos de arquivos, principalmente arquivos de imagem.
