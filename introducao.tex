...
Para fins comprobatórios, serão utilizados dois softwares amplamente utilizados com a finalidade de identificação de arquivos não alocados que serão testados sobre os mesmos parâmetros para que se possa concretizar, através de dados significativos, a eficácia do processo de file carving e de identificação de fragmentos de arquivos não alocados. As ferramentas em questão utilizadas são o Foremost e Scalpel.